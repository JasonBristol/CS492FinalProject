...
public class MainFrame extends javax.swing.JFrame implements LogInterface {
  ...
  private void initComponents() {
    ...
    panelPHA_1Layout.setHorizontalGroup(
      ...
      .addGroup(panelPHA_1Layout.createSequentialGroup()
        ...
        .addGroup(panelPHA_1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
          ...
          .addGroup(panelPHA_1Layout.createSequentialGroup()
            .addGroup(panelPHA_1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
              .addComponent(lblFinDif)
              .addComponent(lblSYN_max))
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(panelPHA_1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    txtSYN_s_n.setEditable(false);
    txtSYN_s_n.setFocusable(false);

    lblFIN_s_n.setText("FIN Scan Normal:");

    txtFST_s_n.setEditable(false);
    txtFST_s_n.setFocusable(false);
      ...
      .addGroup(panelPHA_3Layout.createSequentialGroup()
        ...
        .addGroup(panelPHA_3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
          .addGroup(panelPHA_3Layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(txtSYN_s_n, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
          .addGroup(panelPHA_3Layout.createSequentialGroup()
            .addComponent(lblFIN_s_n)
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(txtFST_s_n, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)))
        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    );
    panelPHA_3Layout.setVerticalGroup(
      ...
      .addGroup(panelPHA_3Layout.createSequentialGroup()
        ...
        .addGroup(panelPHA_3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
          .addComponent(lblSYN_s_n)
          .addComponent(txtSYN_s_n, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        .addGroup(panelPHA_3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
          .addComponent(lblFIN_s_n)
          .addComponent(txtFST_s_n, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    );
    ...
    panelPHALayout.setVerticalGroup(
      ...
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelPHALayout.createSequentialGroup()
        ...
        .addGroup(panelPHALayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
          ...
          .addComponent(panelPHA_2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
          .addComponent(panelPHA_3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        .addContainerGap())
    );
    ...
    private void tbtnCaptureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbtnCaptureActionPerformed
      ...
      JTextField[] packetFields = {txtTotal, txtIncoming, txtSYN1, txtSYNACK1, txtFIN1, txtOutgoing, txtSYN2, txtSYNACK2, txtRST, txtFIN2, p1, p2, p3, p4};
