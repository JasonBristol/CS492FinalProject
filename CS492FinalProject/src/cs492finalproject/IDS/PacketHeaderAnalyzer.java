    ...
    private void ScanDetector(PcapPacket packet) {
      ...
      try {
          if(packet.hasHeader(tcp)) {
              ...
              if (packet.getHeader(ipv4).source() != null && packet.getHeader(ipv4).destination() != null) {
          ...
          //update PHA Panel
          packetPanes[0].setText(total + "");
          packetPanes[1].setText(incoming + "");
          packetPanes[2].setText(iSYNnACK + "");
          packetPanes[3].setText(iSYNACK + "");
          packetPanes[4].setText(iFIN + "");
          packetPanes[5].setText(outgoing + "");
          packetPanes[6].setText(oSYNnACK + "");
