...
public class BoundsPopupMenuListener implements PopupMenuListener {
   ...
   *
   * @param maximumWidth the maximum width of the popup. The popupAbove value is
   * set to "true".
   */
   ...
   *
   * @param scrollBarRequired display a horizontal scrollbar when the preferred
   * width of popup is greater than width of scrollPane.
   ...
   * box or the preferred width of the popup. Normally the popup width is always
   * the same size as the combo box width.
   *
   ...
   *
   * @param scrollBarRequired true add horizontal scrollBar to scrollPane false
