 ...
 * packet. The example also demonstrates how to property peer PcapHeader,
 * JBuffer and initialize a new PcapPacket object which will contain a copy of
 * the peered packet and header data. The libpcap provide header and data are
 * stored in libpcap private memory buffer, which will be overriden with each
 * iteration of the loop. Therefore we use the constructor in PcapPacket to
